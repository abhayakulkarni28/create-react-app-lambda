...
export default class AddNewManagerScreen extends Component {
  ...
  handleAddNewManager(e) {
    ...
    this.form.validateAll();
     ...
     AdminService.addNewManager(this.state.first_name, this.state.middle_name, this.state.last_name, this.state.email, this.state.dob, this.state.gender, this.state.ed_qual).then(
        () => {
  ...
  render () {
    ...
    return (
      ...
      <Navigation/>
      <AdminNavigation/>
      <h1 id="add_new_manager_title">Add New Manager</h1>
